...
class _AboutScreenState extends State<AboutScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    logos = [
      ...
      {'image': 'lib/assets/images/icons/vision2030-logo.jpg', 'name': AppTexts.vision},
      {'image': 'lib/assets/images/icons/moe-logo.png', 'name': AppTexts.moe},
      {'image': 'lib/assets/images/icons/colleage-logo.jpg', 'name': AppTexts.colleage},
      {'image': 'lib/assets/images/icons/sdaia-logo.png', 'name': AppTexts.sdaia},
  ...
  Widget _buildAnimatedLogo(Map<String, String> logo, int index, int totalItems) {
    ...
    return Scaffold(
      body: GradientContainer(
        ...
        myChild: SingleChildScrollView(
          child: Card(
            margin: const EdgeInsets.only(left: 50, right: 50, top: 100, bottom: 70),
            elevation: 20,
            child: Padding(
              padding: const EdgeInsets.only(left: 80, right: 80, bottom: 20, top: 40),
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  return Column(
                    ...
                    children: [
                      _buildAnimatedLogo({'image': 'lib/assets/images/icons/app-logo.png', 'name': AppTexts.appName}, 0, totalLogos + 3),
                      const SizedBox(height: 30),
                      _buildAnimatedText(AppTexts.aboutContent, 1, totalLogos + 3),
                      const SizedBox(height: 40),
                      Wrap(
                        spacing: 60,
                        runSpacing: 20,
                        children: List.generate(logos.length, (index) {
                          return _buildAnimatedLogo(logos[index], index + 2, totalLogos + 3); // Start index offset by 2 due to previous widgets
                        }),
                      ),
                    ],
                  );
